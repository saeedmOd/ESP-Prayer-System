...
function audioPlay() { audioRequest("/api/audio/play", "▶️ تم التشغيل"); }
function audioPause() { audioRequest("/api/audio/pause", "⏸️ تم الإيقاف المؤقت"); }
function audioStop() { audioRequest("/api/audio/stop", "⏹️ تم الإيقاف"); }
function audioVolumeUp() { audioRequest("/api/audio/volume-up", "🔊 تم رفع الصوت"); }
function audioVolumeDown() { audioRequest("/api/audio/volume-down", "🔉 تم خفض الصوت"); }
...
async function testEndpoint(endpoint, successMessage, button = null) {
    if (testBusy) return;
    testBusy = true;
...
function collectAdhkarTab() {
    return {
        ...
        morningAdhkarFolder: readPreset("morningAdhkarPreset", DEFAULTS.morningAdhkar.folder, DEFAULTS.morningAdhkar.file).folder,
        morningAdhkarFile: readPreset("morningAdhkarPreset", DEFAULTS.morningAdhkar.folder, DEFAULTS.morningAdhkar.file).file,
        ...
        eveningAdhkarFolder: readPreset("eveningAdhkarPreset", DEFAULTS.eveningAdhkar.folder, DEFAULTS.eveningAdhkar.file).folder,
        eveningAdhkarFile: readPreset("eveningAdhkarPreset", DEFAULTS.eveningAdhkar.folder, DEFAULTS.eveningAdhkar.file).file,
